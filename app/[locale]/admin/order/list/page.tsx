...
export default async function OrderListPage({ searchParams }: PageProps) {
    ...
    const columns = [
        ...
        { header: t('productName'), accessor: 'productName', className: '' },
        { header: t('quantity'), accessor: 'quantity', className: '' },
        ...
        <>
            ...
            <div className="bg-white p-4 rounded-md flex-1 mt-0">
                <div className="flex items-center lg:justify-between justify-start">
                    <h1 className="hidden lg:block text-lg font-semibold">{t('allOrders')}</h1>
