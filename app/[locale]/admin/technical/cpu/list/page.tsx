...
import { Cpu, Prisma } from '@/prisma/app/generated/prisma';
        ...
        <>
            ...
            <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
                <div className="flex items-center justify-between">
                    <h1 className="hidden md:block text-lg font-semibold">{t('allCpus')}</h1>
                    <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="flex items-center gap-4 self-end">
                            ...
                            <FilterTechnicalDropdown
                                ...
                                entityName={t('cpu')}
                            />
                            <ExportButton exportAction={exportCpus} entityName={t('cpu')} />
                            <ReloadButton />
                            <FormContainer table="cpu" type="create" />
                            <DeleteSelectedButtonClient deleteAction={deleteSelectedCpus} entityName={t('cpu')} />
                        </div>
                    </div>
                </div>
